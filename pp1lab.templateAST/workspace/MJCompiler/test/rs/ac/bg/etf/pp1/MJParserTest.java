...
public class MJParserTest {
	...
	public static void main(String[] args) throws Exception {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(sourceCode))) {
			 ...
			 * 
			 * log.info("Print calls = " + semanticCheck.printCallCount); Tab.dump();
			 * 
			 * if (!p.errorDetected && semanticCheck.passed()) { File objFile = new
			 * File(args[1]); log.info("Generating bytecode file: " +
			 ...
			 * FileOutputStream(objFile)); log.info("Parsiranje uspesno zavrseno!"); } else
